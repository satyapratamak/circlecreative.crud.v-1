<div class="modal-body">
    <form id="ajaxform">
         ...
         <div class="mb-3">
             ...
             <input type="text" class="form-control" id="birth_date" name="birth_date" value="{{ $data->birth_date }}">
        </div>
         <div class="mb-3">
         ...
         <div class="mb-3">
             ...
             <input type="text" class="form-control" id="departement" name="departement" value="{{ $data->departement }}">
        </div>
     </form>
 
 </div>
 <div class="modal-footer">
     <button type="button" class="btn btn-warning" id="btnSaveEditKaryawan" onClick="update({{ $data->id }})"> SAVE </button>
 </div>

 <script> 
    // $("#btnSaveEditKaryawan").click(function(){        
